...
//         try {
//             await client.delete(orderId); // Ensure client.delete is correctly called
//             setOrders((prevOrders) => prevOrders.filter((order) => order._id !== orderId)); // Ensure the filter function is correct
